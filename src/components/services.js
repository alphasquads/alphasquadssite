...
import healthcare from "../content/svg/healthcare.webp"
import education from "../content/svg/education.svg"
import ecommerce from "../content/svg/ecommerce.webp"
import realestate from "../content/svg/realestate.svg"
import startup from "../content/svg/startup.webp"
    ...
    <img  className="  layer layer_1 img-auto position-absolute"  src={featureworkbg} alt="bg image"/>
        ...
        onMouseLeave={this.onMouseLeave}>      <ReactRevealText show={this.state.show}  className="  tittle ">Services </ReactRevealText> </h2> 
            ...
            <div className="row">
                ...
                <img  className="  img-auto"  src={servicesimgjp} alt="services image"/>
                ...
                <div className="row p_service_info">
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.3s" >
                            <div className="icon icon_one"><img  className=" img-auto pad-8"  src={designicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                            <div className="icon icon_two"><img  className=" img-auto pad-8"  src={designicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item wow fadeInLeft" data-wow-delay="0.4s" >
                            <div className="icon icon_three"><img  className=" img-auto pad-8"  src={designicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.7s" >
                            <div className="icon icon_four"><img  className=" img-auto pad-8"  src={designicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                            <div className="icon icon_five"><img  className=" img-auto pad-8"  src={designicon} alt="icon"/></div>
  ...
  <h2 id="developmentid" onMouseEnter={this.onMouseEnter}
        onMouseLeave={this.onMouseLeave}>      <ReactRevealText show={this.state.show}  className="   pad-top-50 f_size_30 f_600 t_color3  l_height45 text-center mb_90 wow fadeInUp ">DEVELOPMENT </ReactRevealText> </h2> 
                ...
                <div className="row p_service_info">
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.3s" >
                            <div className="icon icon_one"><img  className=" img-auto pad-8"  src={developmenticon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                            <div className="icon icon_two"><img  className=" img-auto pad-8"  src={developmenticon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item wow fadeInLeft" data-wow-delay="0.4s" >
                            <div className="icon icon_three"><img  className=" img-auto pad-8"  src={developmenticon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.7s" >
                            <div className="icon icon_four"><img  className=" img-auto pad-8"  src={developmenticon} alt="icon"/></div>
  ...
  <h2 id="marketingid" onMouseEnter={this.onMouseEnter}
        onMouseLeave={this.onMouseLeave}>      <ReactRevealText show={this.state.show}  className="  pad-top-50 f_size_30 f_600 t_color3 l_height45 text-center mb_90 wow fadeInUp  ">DIGITAL MARKETING </ReactRevealText> </h2> 
                ...
                <div className="row p_service_info">
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.3s" >
                            <div className="icon icon_one"><img  className=" img-auto pad-8"  src={marketingicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                            <div className="icon icon_two"><img  className=" img-auto pad-8"  src={marketingicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item wow fadeInLeft" data-wow-delay="0.4s" >
                            <div className="icon icon_three"><img  className=" img-auto pad-8"  src={marketingicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.7s" >
                            <div className="icon icon_four"><img  className=" img-auto pad-8"  src={marketingicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                            <div className="icon icon_five"><img  className=" img-auto pad-8"  src={marketingicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item wow fadeInLeft" data-wow-delay="0.7s" >
                            <div className="icon icon_six"><img  className=" img-auto pad-8"  src={marketingicon} alt="icon"/></div>
  ...
  <h2  id="businessid" onMouseEnter={this.onMouseEnter}
        onMouseLeave={this.onMouseLeave}>      <ReactRevealText show={this.state.show}  className="  pad-top-50 f_size_30 f_600 t_color3 l_height45 text-center mb_90 wow fadeInUp  ">BUSINESS </ReactRevealText> </h2> 
                ...
                <div className="row p_service_info">
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.3s" >
                            <div className="icon icon_one"><img  className=" img-auto pad-8"  src={businessicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                            <div className="icon icon_two"><img  className=" img-auto pad-8"  src={businessicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item wow fadeInLeft" data-wow-delay="0.4s" >
                            <div className="icon icon_three"><img  className=" img-auto pad-8"  src={businessicon} alt="icon"/></div>
                    ...
                    <div className="col-lg-3 col-sm-4 text-center-webkit">
                        <div className="p_service_item  wow fadeInLeft" data-wow-delay="0.7s" >
                            <div className="icon icon_four"><img  className=" img-auto pad-8"  src={businessicon} alt="icon"/></div>
        ...
        onMouseLeave={this.onMouseLeave}>      <ReactRevealText show={this.state.show}  className=" f_size_30 f_600 t_color3 l_height45 text-center mb_90 wow fadeInUp  ">Industries we work with </ReactRevealText> </h2> 
                ...
                <div className="row p_service_info">
                      <div className="col-lg-5 col-sm-6 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                        <img  className=" img-auto"  src={healthcare} alt="health care"/>
                        ...
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                        <img  className=" img-auto"  src={ecommerce} alt="e-commerce"/>
                    ...
                    <div className="col-lg-5  col-sm-6 text-center-webkit">
                        <div className="p_service_item   wow fadeInLeft" data-wow-delay="0.5s" >
                        <img  className=" img-auto"  src={education} alt="education"/>
